...
public class SqltoolTest {
	...
	public static void main(String[] args) {
		 ...
		 */
		// 测试SqltoolContext
		sqltoolContext(sqltoolContext, mysql);
		 ...
		 */
		// 测试SqltoolContext
		sqltoolContext(sqltoolContext, oracle);
	}

	private static void sqltoolContext(SqltoolContext sqltoolContext, Map<String, String> options) {
		// 测试插入数据
