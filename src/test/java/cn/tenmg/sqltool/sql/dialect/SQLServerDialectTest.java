...
public class SQLServerDialectTest implements SQLDialectTest {
	...
	public void testBasicDaoWithDBCP2() {
		doTest(SqltoolFactory.createDao("sqlserver-basic-dbcp2.properties"));
	}

	@Test
	@Override
	public void testBasicDaoWithDruid() {
		doTest(SqltoolFactory.createDao("sqlserver-basic-druid.properties"));
	}

	@Test
	@Override
	public void testDistributedDaoWithDBCP2() {
		doTest(SqltoolFactory.createDao("sqlserver-distributed-dbcp2.properties"));
	}

	@Test
	@Override
	public void testDistributedDaoWithDruid() {
		doTest(SqltoolFactory.createDao("sqlserver-distributed-druid.properties"));
	}
